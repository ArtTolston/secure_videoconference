...
class Ui_MainWindow(object):
    ...
    def display_video_stream(self):
        ...
        print(f'bframe md5 after receiving(encrypted): {hashlib.md5(bframe)}')
        if self.cipher == "Public key exchange":
            bframe = self.handler.get_crypto().aes_decrypt(bframe)
        else:
            pass
        print(f'bframe md5 after decrypting(only pickling): {hashlib.md5(bframe)}')
    ...
    def send_video_stream(self):
        ...
        print(f'bframe md5 after pickling: {hashlib.md5(bframe)}')
        if self.cipher == "Public key exchange":
            print(self.handler.get_crypto().session_key)
            bframe = self.handler.get_crypto().aes_encrypt(bframe)
        else:
            pass
        print(f'bframe md5 after encrypting: {hashlib.md5(bframe)}')
